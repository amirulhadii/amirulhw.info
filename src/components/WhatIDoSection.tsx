...
const testimonials = [
  ...
  },
  {
    ...
    logoAlt: "Tokopedia",
    quote:
      "Amirul always goes above and beyond to deliver value to our team, from taking on many projects from discovery to delivery. He builds strong collaborative relationships with many stakeholders in Tokopedia, everyone respects and values his contribution.",
    role: "AVP of Product",
    year: "2024",
  },
  {
    ...
    logoAlt: "Hiteta",
    quote:
      "Arsitag really needed a brand new look and feel and we struggled in that aspect. Thankfully Hiteta came in and recommended the right UI/UX designer to finally complete what couldn't be done by ourselves alone.",
          ...
          {testimonials.map((item, index) => (
            ...
            >
              <div className="flex items-center justify-center w-14 h-14 rounded-full bg-white shadow-sm mb-6">
                <img src={item.logo} alt={item.logoAlt} className="w-9 h-9 object-contain" />
              </div>
              <p className="text-muted-foreground leading-relaxed mb-6 text-sm md:text-base italic">"{item.quote}"</p>
