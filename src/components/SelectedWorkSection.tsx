...
const selectedWorks = [
  {
    number: "01",
    title: "Marketplace Search Redesign",
    metrics: [
      "Increased conversion 34%,",
      "$2.1M additional GMV monthly.",
      "Shipped in 6 weeks.",
    ],
    image: kulionerImg,
    caseStudyLink: "#",
  },
  {
    ...
    metrics: [
      "Reduced delivery time 18%,",
      "saved $400K annually in ops costs.",
      "10M+ parcels processed.",
    ],
    image: uixImg,
    caseStudyLink: "#",
  },
  {
    ...
    metrics: [
      "0 to 50K creators in 4 months.",
      "$1.2M revenue first quarter.",
